package org.opennfr.nfrdroid.tv.presenter;
...
import org.opennfr.nfrdroid.tv.view.TextCardView;
...
public class CardPresenter extends Presenter {
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent) {
		mDefaultBackgroundColor =
				ContextCompat.getColor(parent.getContext(), R.color.primary_nfrdroid);
		mSelectedBackgroundColor =
				ContextCompat.getColor(parent.getContext(), R.color.primary_material_dark);
		mDefaultCardImage = parent.getResources().getDrawable(R.drawable.nfrdroid_logo_simple, null);
