...
import org.opennfr.nfrdroid.tv.BrowseItem;
import org.opennfr.nfrdroid.tv.activities.PreferenceActivity;
import org.opennfr.nfrdroid.tv.fragment.abs.BaseHttpBrowseFragment;
import org.opennfr.nfrdroid.tv.presenter.CardPresenter;
...
public class RootBrowseFragment extends BaseHttpBrowseFragment implements ProfileChangedListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setBrandColor(ContextCompat.getColor(getContext(), R.color.primary_nfrdroid));
		setBadgeDrawable(ContextCompat.getDrawable(getContext(), R.drawable.nfrdroid_header));
		addSettingsRow();
		mRequireReload = true;
	}
	...
	@Override
	public void onStop() {
		nfrDroid.setCurrentProfileChangedListener(null);
		super.onStop();
	}
