...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public static final String DATABASE_NAME = "nfrdroid";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		if(scheduleBackup)
			nfrDroid.scheduleBackup(mContext);
	}
	...
	public boolean updateProfile(Profile p) {
		...
		if (numRows == 1) {
			nfrDroid.scheduleBackup(mContext);
			nfrDroid.profileChanged(mContext, p);
			return true;
		}
		return false;
	}
    ...
    public boolean exportDB(){
        ...
        String currentDBPath = "/data/org.opennfr.nfrdroid" +"/databases/" + DATABASE_NAME;
