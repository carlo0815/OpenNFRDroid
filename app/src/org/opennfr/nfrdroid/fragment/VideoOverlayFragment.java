...
import org.opennfr.nfrdroid.activities.VideoActivity;
...
import org.opennfr.nfrdroid.tv.fragment.EpgDetailDialog;
import org.opennfr.nfrdroid.tv.fragment.MovieDetailDialog;
import org.opennfr.nfrdroid.video.VLCPlayer;
import org.opennfr.nfrdroid.view.OnRepeatListener;
import org.opennfr.nfrdroid.widget.helper.ItemClickSupport;
import org.opennfr.nfrdroid.widget.helper.SpacesItemDecoration;
	...
	public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mGestureDector = new GestureDetectorCompat(getActivity(), new GestureDetector.SimpleOnGestureListener() {
			...
			public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
				boolean isGesturesEnabled = PreferenceManager.getDefaultSharedPreferences(getActivity()).getBoolean(nfrDroid.PREFS_KEY_VIDEO_ENABLE_GESTURES, true);
			...
			if (isRecording()) {
				...
				if (duration != null && start != null && !Python.NONE.equals(duration) && !Python.NONE.equals(start)) {
					try {
						...
						Log.e(nfrDroid.LOG_TAG, e.toString());
					}
				}
			}
		}
