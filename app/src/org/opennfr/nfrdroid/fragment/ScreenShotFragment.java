...
import org.opennfr.nfrdroid.loader.AsyncByteLoader;
...
//		performFileSearch();
		...
		if (mRawImage != null) {
			...
			if (inCache) {
				...
				fileName = String.format("visionDroid_%s.%s", timestamp, extension);
			}
			...
			try {
				...
				Log.e(nfrDroid.LOG_TAG, e.getLocalizedMessage());
