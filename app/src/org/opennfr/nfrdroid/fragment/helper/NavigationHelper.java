package org.opennfr.nfrdroid.fragment.helper;
...
import org.opennfr.nfrdroid.activities.MainActivity;
import org.opennfr.nfrdroid.activities.SimpleNoTitleFragmentActivity;
import org.opennfr.nfrdroid.activities.SimpleToolbarFragmentActivity;
import org.opennfr.nfrdroid.asynctask.SetPowerStateTask;
import org.opennfr.nfrdroid.asynctask.SimpleResultTask;
import org.opennfr.nfrdroid.asynctask.SleepTimerTask;
import org.opennfr.nfrdroid.fragment.BackupFragment;
import org.opennfr.nfrdroid.fragment.CurrentServiceFragment;
import org.opennfr.nfrdroid.fragment.DeviceInfoFragment;
import org.opennfr.nfrdroid.fragment.EpgBouquetFragment;
import org.opennfr.nfrdroid.fragment.MediaPlayerFragment;
import org.opennfr.nfrdroid.fragment.MovieListFragment;
import org.opennfr.nfrdroid.fragment.MyPreferenceFragment;
import org.opennfr.nfrdroid.fragment.ProfileListFragment;
import org.opennfr.nfrdroid.fragment.ScreenShotFragment;
import org.opennfr.nfrdroid.fragment.ServiceListFragment;
import org.opennfr.nfrdroid.fragment.SignalFragment;
import org.opennfr.nfrdroid.fragment.TimerListFragment;
import org.opennfr.nfrdroid.fragment.VirtualRemotePagerFragment;
import org.opennfr.nfrdroid.fragment.ZapFragment;
import org.opennfr.nfrdroid.fragment.dialogs.AboutDialog;
import org.opennfr.nfrdroid.fragment.dialogs.SendMessageDialog;
import org.opennfr.nfrdroid.fragment.dialogs.SimpleChoiceDialog;
import org.opennfr.nfrdroid.fragment.dialogs.SleepTimerDialog;
...
import org.opennfr.nfrdroid.helpers.enigma2.Message;
import org.opennfr.nfrdroid.helpers.enigma2.PowerState;
import org.opennfr.nfrdroid.helpers.enigma2.SimpleResult;
import org.opennfr.nfrdroid.helpers.enigma2.SleepTimer;
import org.opennfr.nfrdroid.helpers.enigma2.requesthandler.MessageRequestHandler;
import org.opennfr.nfrdroid.helpers.enigma2.requesthandler.SimpleResultRequestHandler;
    ...
    protected boolean onNavigationItemClick(int itemId) {
        ...
        switch (itemId) {
            ...
            case Statics.ITEM_CHECK_CONN:
                getMainActivity().onProfileChanged(nfrDroid.getCurrentProfile());
                break;
            ...
            case R.id.menu_navigation_epg:
                ...
                String ref = nfrDroid.getCurrentProfile().getDefaultRef();
                args.putString(Event.KEY_SERVICE_REFERENCE, ref);

                String name = nfrDroid.getCurrentProfile().getDefaultRefName();
