...
import org.opennfr.nfrdroid.helpers.enigma2.Remote;
...
public class VirtualRemoteFragment extends BaseHttpFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mQuickZap = getArguments().getBoolean(nfrDroid.PREFS_KEY_QUICKZAP, prefs.getBoolean(nfrDroid.PREFS_KEY_QUICKZAP, false) );
		mSimpleRemote = nfrDroid.getCurrentProfile().isSimpleRemote();
