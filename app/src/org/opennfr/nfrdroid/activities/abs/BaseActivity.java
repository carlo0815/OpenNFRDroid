package org.opennfr.nfrdroid.activities.abs;
...
import org.opennfr.nfrdroid.helpers.PiconSyncService;
import org.opennfr.nfrdroid.helpers.Statics;
import org.opennfr.nfrdroid.nfrDroid;
import org.opennfr.nfrdroid.util.IabException;
import org.opennfr.nfrdroid.util.IabHelper;
import org.opennfr.nfrdroid.util.IabResult;
import org.opennfr.nfrdroid.util.Inventory;
import org.opennfr.nfrdroid.util.Purchase;
import org.opennfr.nfrdroid.util.SkuDetails;
...
public class BaseActivity extends AppCompatActivity implements ActionDialog.DialogActionListener, SharedPreferences.OnSharedPreferenceChangeListener {
	...
	private void initIAB() {
		...
		mInventory = null;
		mIabReady = false;
		mIabHelper = new IabHelper(this, nfrDroid.IAB_PUB_KEY);
		...
		mIabHelper.startSetup(result -> {
			...
			mIabReady = true;
			ArrayList<String> skuList = new ArrayList<>(Arrays.asList(nfrDroid.SKU_LIST));
