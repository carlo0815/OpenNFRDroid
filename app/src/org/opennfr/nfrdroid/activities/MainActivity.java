...
import org.opennfr.nfrdroid.BuildConfig;
import org.opennfr.nfrdroid.nfrDroid;
import org.opennfr.nfrdroid.Profile;
import org.opennfr.nfrdroid.ProfileChangedListener;
...
import org.opennfr.nfrdroid.asynctask.CheckProfileTask;
import org.opennfr.nfrdroid.fragment.ActivityCallbackHandler;
import org.opennfr.nfrdroid.fragment.EpgSearchFragment;
import org.opennfr.nfrdroid.fragment.ProfileEditFragment;
import org.opennfr.nfrdroid.fragment.ProfileListFragment;
import org.opennfr.nfrdroid.fragment.dialogs.ActionDialog;
import org.opennfr.nfrdroid.fragment.dialogs.ChangelogDialog;
import org.opennfr.nfrdroid.fragment.dialogs.ConnectionErrorDialog;
...
import org.opennfr.nfrdroid.fragment.helper.NavigationHelper;
import org.opennfr.nfrdroid.fragment.interfaces.IHttpBase;
...
public class MainActivity extends BaseActivity implements MultiPaneHandler, ProfileChangedListener,
    ...
    public void onProfileChecked(final ExtendedHashMap result) {
        ...
        boolean isFirstStart = sp.getBoolean(nfrDroid.PREFS_KEY_FIRST_START, true);
        if (isFirstStart)
        ...
        if (isFirstStart) {
            if (!isNavigationDrawerVisible())
                toggle();
            sp.edit().putBoolean(nfrDroid.PREFS_KEY_FIRST_START, false).apply();
        }
    }
    ...
    public void showErrorDetails(ExtendedHashMap result) {
        ...
        Profile p = nfrDroid.getCurrentProfile();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        nfrDroid.setCurrentProfileChangedListener(this);
        showChangeLog(true);
    }
    ...
    public void showChangeLog(boolean onUpdateOnly) {
        ...
        int lastVersionCode = preferences.getInt(nfrDroid.PREFS_KEY_LAST_VERSION_CODE, 0);
        boolean updated = lastVersionCode < BuildConfig.VERSION_CODE;
        if (updated) {
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt(nfrDroid.PREFS_KEY_LAST_VERSION_CODE, BuildConfig.VERSION_CODE);
            editor.apply();
        }
    ...
    private boolean checkNavigationHelper() {
        if (mNavigationHelper == null) {
            ...
            onProfileChanged(nfrDroid.getCurrentProfile());
            return true;
        }
        return false;
    }
    ...
    public void onBackPressed() {
        ...
        boolean shouldConfirm = PreferenceManager.getDefaultSharedPreferences(this).getBoolean(
                nfrDroid.PREFS_KEY_CONFIRM_APP_CLOSE, true);
    ...
    public void setProfileName() {
        mActiveProfile.setText(nfrDroid.getCurrentProfile().getName());
    }
    ...
    public void showDetails(Fragment fragment, boolean addToBackStack) {
        ...
        if (mDetailFragment != null
                ...
                nfrDroid.PREFS_KEY_ENABLE_ANIMATIONS, true))
    ...
    public void onDialogAction(int action, Object details, String dialogTag) {
        ...
        if ("connection_error".equals(dialogTag)) {
            ...
            ProfileListFragment.openProfileEditActivity(this, nfrDroid.getCurrentProfile());
            return;
        }
    ...
    public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
        Log.w(nfrDroid.LOG_TAG, key);
        if (nfrDroid.PREFS_KEY_THEME_TYPE.equals(key)) {
            nfrDroid.setTheme(this);
            if (!mIsPaused)
                recreate();
        }
