...
package org.opennfr.nfrdroid.intents;
...
public class IntentFactory {
	...
	private static Intent getVideoIntent(Context context, String uriString) {
		Intent intent;
		if(PreferenceManager.getDefaultSharedPreferences(context).getBoolean(nfrDroid.PREFS_KEY_INTEGRATED_PLAYER, true))
	...
	public static Intent getStreamServiceIntent(Context context, String ref, String title, String bouquetRef, ExtendedHashMap serviceInfo) {
		...
		Log.i(nfrDroid.LOG_TAG, "Service-Streaming URL set to '" + uriString + "'");
		...
		if(serviceInfo != null && PreferenceManager.getDefaultSharedPreferences(context).getBoolean(nfrDroid.PREFS_KEY_INTEGRATED_PLAYER, true))
	...
	public static Intent getStreamFileIntent(Context context, String ref, String fileName, String title, ExtendedHashMap fileInfo) {
		...
		Log.i(nfrDroid.LOG_TAG, "File-Streaming URL set to '" + uriString + "'");
		Intent intent = getVideoIntent(context, uriString);
		intent.putExtra("title", title);
		if(fileInfo != null && PreferenceManager.getDefaultSharedPreferences(context).getBoolean(nfrDroid.PREFS_KEY_INTEGRATED_PLAYER, true))
