...
import org.opennfr.nfrdroid.helpers.enigma2.requestinterfaces.SimpleRequestInterface;
...
public abstract class AbstractSimpleRequestHandler implements SimpleRequestInterface {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.opennfr.nfrdroid.helpers.enigma2.requesthandler.
	 * SimpleRequestParamInterface
	 * #get(org.opennfr.nfrdroid.helpers.SimpleHttpClient,
	 * java.util.ArrayList)
	 */
