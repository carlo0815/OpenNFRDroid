...
package org.opennfr.opennfrdroid.fragment.dialogs;
...
public class AboutDialog extends ActionDialog {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		String text = String.format("%s\n\n%s\n\n%s", OpenNFRDroid.VERSION_STRING, getString(R.string.license_gplv3),
		...
		builder.setNegativeButton(R.string.licenses, (dialog, which) -> {
			OpenNFRDroidAttributionPresenter.newInstance(getContext()).showDialog(getString(R.string.licenses));
		});
