...
import org.opennfr.opennfrdroid.helpers.enigma2.Remote;
...
public class VirtualRemoteFragment extends BaseHttpFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mQuickZap = getArguments().getBoolean(OpenNFRDroid.PREFS_KEY_QUICKZAP, prefs.getBoolean(OpenNFRDroid.PREFS_KEY_QUICKZAP, false) );
		mSimpleRemote = OpenNFRDroid.getCurrentProfile().isSimpleRemote();
