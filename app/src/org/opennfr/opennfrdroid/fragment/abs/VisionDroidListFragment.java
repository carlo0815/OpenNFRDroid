 ...
 * @author sre
 */
public abstract class OpenNFRDroidListFragment extends ListFragment implements ActivityCallbackHandler, IMutliPaneContent {
	...
	public OpenNFRDroidListFragment() {
		super();
