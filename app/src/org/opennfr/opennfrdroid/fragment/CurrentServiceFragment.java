...
import org.opennfr.opennfrdroid.fragment.abs.BaseHttpFragment;
...
import org.opennfr.opennfrdroid.helpers.enigma2.CurrentService;
...
import org.opennfr.opennfrdroid.helpers.enigma2.Timer;
import org.opennfr.opennfrdroid.helpers.enigma2.requesthandler.CurrentServiceRequestHandler;
import org.opennfr.opennfrdroid.helpers.enigma2.requesthandler.TimerAddByEventIdRequestHandler;
import org.opennfr.opennfrdroid.intents.IntentFactory;
import org.opennfr.opennfrdroid.loader.AsyncSimpleLoader;
...
public class CurrentServiceFragment extends BaseHttpFragment {
	 ...
	 * 
	 * @see
	 * org.opennfr.opennfrdroid.abstivities.AbstractHttpListActivity#onSimpleResult
	 * (boolean, org.opennfr.opennfrdroid.helpers.ExtendedHashMap)
	 */
