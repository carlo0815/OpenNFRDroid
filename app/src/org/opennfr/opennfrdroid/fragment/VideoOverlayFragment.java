...
import org.opennfr.opennfrdroid.activities.VideoActivity;
...
import org.opennfr.opennfrdroid.helpers.DateTime;
...
import org.opennfr.opennfrdroid.tv.fragment.EpgDetailDialog;
import org.opennfr.opennfrdroid.tv.fragment.MovieDetailDialog;
import org.opennfr.opennfrdroid.video.VLCPlayer;
import org.opennfr.opennfrdroid.view.OnRepeatListener;
import org.opennfr.opennfrdroid.widget.helper.ItemClickSupport;
import org.opennfr.opennfrdroid.widget.helper.SpacesItemDecoration;
...
public class VideoOverlayFragment extends Fragment implements MediaPlayer.EventListener,
	...
	public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if (mServicesView != null) {
			if (OpenNFRDroid.isTV(getContext())) {
		...
		mGestureDector = new GestureDetectorCompat(getActivity(), new GestureDetector.SimpleOnGestureListener() {
			...
			public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
				boolean isGesturesEnabled = PreferenceManager.getDefaultSharedPreferences(getActivity()).getBoolean(OpenNFRDroid.PREFS_KEY_VIDEO_ENABLE_GESTURES, true);
			...
			if (isRecording()) {
				...
				if (duration != null && start != null && !Python.NONE.equals(duration) && !Python.NONE.equals(start)) {
					try {
						...
						Log.e(OpenNFRDroid.LOG_TAG, e.toString());
					}
				}
			}
		}
