...
import org.opennfr.opennfrdroid.loader.AsyncByteLoader;
...
//		performFileSearch();
		...
		if (mRawImage != null) {
			...
			if (inCache) {
				...
				fileName = String.format("opennfrDroid_%s.%s", timestamp, extension);
			}
			...
			try {
				...
				Log.e(OpenNFRDroid.LOG_TAG, e.getLocalizedMessage());
