package org.opennfr.opennfrdroid.activities.abs;
...
import org.opennfr.opennfrdroid.helpers.PiconSyncService;
import org.opennfr.opennfrdroid.helpers.Statics;
import org.opennfr.opennfrdroid.util.IabException;
import org.opennfr.opennfrdroid.util.IabHelper;
import org.opennfr.opennfrdroid.util.IabResult;
import org.opennfr.opennfrdroid.util.Inventory;
import org.opennfr.opennfrdroid.util.Purchase;
import org.opennfr.opennfrdroid.util.SkuDetails;
...
public class BaseActivity extends AppCompatActivity implements ActionDialog.DialogActionListener, SharedPreferences.OnSharedPreferenceChangeListener {
	...
	private void initIAB() {
		...
		mInventory = null;
		mIabReady = false;
		mIabHelper = new IabHelper(this, OpenNFRDroid.IAB_PUB_KEY);
		...
		mIabHelper.startSetup(result -> {
			...
			mIabReady = true;
			ArrayList<String> skuList = new ArrayList<>(Arrays.asList(OpenNFRDroid.SKU_LIST));
	...
	public void consumeAll(Inventory inventory) {
		...
		for (String sku : OpenNFRDroid.SKU_LIST) {
