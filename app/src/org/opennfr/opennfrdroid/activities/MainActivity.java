...
import org.opennfr.opennfrdroid.BuildConfig;
import org.opennfr.opennfrdroid.OpenNFRDroid;
import org.opennfr.opennfrdroid.Profile;
import org.opennfr.opennfrdroid.ProfileChangedListener;
import org.opennfr.opennfrdroid.R;
import org.opennfr.opennfrdroid.activities.abs.BaseActivity;
import org.opennfr.opennfrdroid.activities.abs.MultiPaneHandler;
import org.opennfr.opennfrdroid.asynctask.CheckProfileTask;
import org.opennfr.opennfrdroid.fragment.ActivityCallbackHandler;
import org.opennfr.opennfrdroid.fragment.EpgSearchFragment;
import org.opennfr.opennfrdroid.fragment.ProfileEditFragment;
...
import org.opennfr.opennfrdroid.fragment.dialogs.ChangelogDialog;
import org.opennfr.opennfrdroid.fragment.dialogs.ConnectionErrorDialog;
...
import org.opennfr.opennfrdroid.fragment.helper.NavigationHelper;
import org.opennfr.opennfrdroid.fragment.interfaces.IHttpBase;
...
public class MainActivity extends BaseActivity implements MultiPaneHandler, ProfileChangedListener,
	...
	public void onProfileChecked(final ExtendedHashMap result) {
		...
		boolean isFirstStart = sp.getBoolean(OpenNFRDroid.PREFS_KEY_FIRST_START, true);
		if (isFirstStart)
		...
		if (isFirstStart) {
			if (!isNavigationDrawerVisible())
				toggle();
			sp.edit().putBoolean(OpenNFRDroid.PREFS_KEY_FIRST_START, false).apply();
		}
	}
	...
	public void showErrorDetails(ExtendedHashMap result) {
		...
		Profile p = OpenNFRDroid.getCurrentProfile();
	...
	public void onCreate(Bundle savedInstanceState) {
		OpenNFRDroid.setTheme(this);
		super.onCreate(savedInstanceState);

		mIsDrawerOpen = false;
		mCurrentProfile = Profile.getDefault();
		initViews();
		OpenNFRDroid.setCurrentProfileChangedListener(this);
		showChangeLog(true);
	}
	...
	public void showChangeLog(boolean onUpdateOnly) {
		...
		int lastVersionCode = preferences.getInt(OpenNFRDroid.PREFS_KEY_LAST_VERSION_CODE, 0);
		boolean updated = lastVersionCode < BuildConfig.VERSION_CODE;
		if (updated) {
			SharedPreferences.Editor editor = preferences.edit();
			editor.putInt(OpenNFRDroid.PREFS_KEY_LAST_VERSION_CODE, BuildConfig.VERSION_CODE);
			editor.apply();
		}
	...
	private boolean checkNavigationHelper() {
		if (mNavigationHelper == null) {
			...
			onProfileChanged(OpenNFRDroid.getCurrentProfile());
			return true;
		}
		return false;
	}
	...
	public void onBackPressed() {
		...
		boolean shouldConfirm = PreferenceManager.getDefaultSharedPreferences(this).getBoolean(
				OpenNFRDroid.PREFS_KEY_CONFIRM_APP_CLOSE, true);
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.opennfr.opennfrdroid.OnActiveProfileChangedListener#
	 * onActiveProfileChanged(org.opennfr.opennfrdroid.Profile)
	 */
	@Override
	...
	public void setProfileName() {
		mActiveProfile.setText(OpenNFRDroid.getCurrentProfile().getName());
	}
	 ...
	 *
	 * @see
	 * org.opennfr.opennfrdroid.abstivities.MultiPaneHandler#showDetails(java
	 ...
	 *
	 * @see
	 * org.opennfr.opennfrdroid.abstivities.MultiPaneHandler#showDetails(android
	...
	public void showDetails(Fragment fragment, boolean addToBackStack) {
		...
		if (mDetailFragment != null
				...
				OpenNFRDroid.PREFS_KEY_ENABLE_ANIMATIONS, true))
	 ...
	 * (non-Javadoc)
	 *
	 * @see org.opennfr.opennfrdroid.fragment.dialogs.EpgDetailBottomSheet.
	...
	public void onDialogAction(int action, Object details, String dialogTag) {
		...
		if ("connection_error".equals(dialogTag)) {
			...
			ProfileListFragment.openProfileEditActivity(this, OpenNFRDroid.getCurrentProfile());
			return;
		}
	...
	public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
		Log.w(OpenNFRDroid.LOG_TAG, key);
		if (OpenNFRDroid.PREFS_KEY_THEME_TYPE.equals(key)) {
			OpenNFRDroid.setTheme(this);
			if (!mIsPaused)
				recreate();
		}
