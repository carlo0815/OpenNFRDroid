package org.opennfr.opennfrdroid.helpers.enigma2.epgsync;
...
public class EpgDatabase {
    ...
    public void syncBouquet(Context context, String reference){
        ...
        mBuilder = new NotificationCompat.Builder(context, "opennfrdroid_picon_sync");
        ...
        SimpleHttpClient shc = SimpleHttpClient.getInstance(OpenNFRDroid.getCurrentProfile());
