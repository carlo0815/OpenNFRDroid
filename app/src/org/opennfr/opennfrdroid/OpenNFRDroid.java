...
package org.opennfr.opennfrdroid;
...
import org.opennfr.opennfrdroid.helpers.enigma2.requesthandler.LocationListRequestHandler;
import org.opennfr.opennfrdroid.helpers.enigma2.requesthandler.TagListRequestHandler;
 ...
 * @author sre
 */
public class OpenNFRDroid extends MatomoApplication {
	private static volatile OpenNFRDroid instance;
	...
	public static final String ACTION_CREATE = "opennfrdroid.intent.action.NEW";
	public static final String LOG_TAG = "OpenNFRDroid";
	...
	public static Context getAppContext() {
		if (instance != null) return instance;
			...
			try {
				instance = (OpenNFRDroid) Class.forName("android.app.ActivityThread").getDeclaredMethod("currentApplication").invoke(null);
	...
	private void initChannels() {
		...
		NotificationChannel channel = new NotificationChannel("opennfrdroid_picon_sync",
				getString(R.string.picons),
				NotificationManager.IMPORTANCE_LOW);
		channel.setDescription(getString(R.string.sync_picons));
		notificationManager.createNotificationChannel(channel);

		channel = new NotificationChannel("opennfrdroid_epg_sync",
	...
	public static boolean setCurrentProfile(Context context, int id, boolean forceEvent) {
		...
		if (sProfile != null) {
			...
			Log.w(OpenNFRDroid.LOG_TAG, "no profile with given id [" + id + "] found");
		}
		return false;
	}
	...
	public static boolean isTV(Context context) {
		return context.getResources().getBoolean(R.bool.is_teleopennfrDroid);
	}
}
