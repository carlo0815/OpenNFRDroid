...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public static final String DATABASE_NAME = "opennfrdroid";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		if(scheduleBackup)
			OpenNFRDroid.scheduleBackup(mContext);
	}
	...
	public boolean updateProfile(Profile p) {
		...
		if (numRows == 1) {
			OpenNFRDroid.scheduleBackup(mContext);
			OpenNFRDroid.profileChanged(mContext, p);
			return true;
		}
		return false;
	}
    ...
    public boolean exportDB(){
        ...
        String currentDBPath = "/data/org.opennfr.opennfrdroid" +"/databases/" + DATABASE_NAME;
