package org.opennfr.opennfrdroid.tv.presenter;
...
import org.opennfr.opennfrdroid.tv.view.TextCardView;
...
public class CardPresenter extends Presenter {
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent) {
		mDefaultBackgroundColor =
				ContextCompat.getColor(parent.getContext(), R.color.primary_opennfrdroid);
		mSelectedBackgroundColor =
				ContextCompat.getColor(parent.getContext(), R.color.primary_material_dark);
		mDefaultCardImage = parent.getResources().getDrawable(R.drawable.opennfrdroid_logo_simple, null);
