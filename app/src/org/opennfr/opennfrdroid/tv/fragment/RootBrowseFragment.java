...
import org.opennfr.opennfrdroid.tv.BrowseItem;
import org.opennfr.opennfrdroid.tv.activities.PreferenceActivity;
import org.opennfr.opennfrdroid.tv.fragment.abs.BaseHttpBrowseFragment;
import org.opennfr.opennfrdroid.tv.presenter.CardPresenter;
...
public class RootBrowseFragment extends BaseHttpBrowseFragment implements ProfileChangedListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setBrandColor(ContextCompat.getColor(getContext(), R.color.primary_opennfrdroid));
		setBadgeDrawable(ContextCompat.getDrawable(getContext(), R.drawable.opennfrdroid_header));
		addSettingsRow();
		mRequireReload = true;
	}
	...
	@Override
	public void onStop() {
		OpenNFRDroid.setCurrentProfileChangedListener(null);
		super.onStop();
	}
